...
const securityFeatures = [
  {
    ...
    description: "Immutable batch proofs committed to Solana L1.",
    image: "/images/isolated.jpg",
  },
  {
    icon: Lock,
    title: "Zero MEV exposure",
    description: "Private batching in ER prevents front-running.",
    image: "/images/encrypted.jpg",
  },
  {
    icon: Eye,
    title: "Full audit trails",
    description: "Every token event logged with cryptographic proof.",
    image: "/images/audit.jpg",
  },
  {
    icon: FileCheck,
    title: "Trustless verification",
    description: "Batch commitments verifiable by any validator.",
    image: "/images/permissions.jpg",
  },
];

const certifications = ["Solana L1", "Ephemeral Rollups", "QuickNode", "SPL Token"];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-20">
          ...
          <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] mb-12 transition-all duration-1000 ${
            ...
            Fast,
            <br />
            <span className="text-muted-foreground">not insecure.</span>
          </h2>
          ...
          <div className={`transition-all duration-1000 delay-100 ${
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl">
              Ephemeral Rollups deliver speed without sacrificing trust. Every batch settles to Solana with cryptographic proof.
            </p>
          </div>
        </div>
