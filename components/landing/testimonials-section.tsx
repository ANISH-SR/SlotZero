...
const testimonials = [
  {
    quote: "I caught a whale movement on JUP before it hit Twitter. The 100ms stream latency is a game changer for my trades.",
    author: "Marcus Chen",
    role: "Day Trader",
    company: "Alpha Trading",
    metric: { value: "3x", label: "Trade win rate" },
  },
  {
    quote: "The anomaly alerts detected a coordinated pump on a new token before it went parabolic. Saved me from a bad entry.",
    author: "Elena Voss",
    role: "DeFi Analyst",
    company: "BlockPulse Research",
    metric: { value: "98%", label: "Anomaly accuracy" },
  },
  {
    quote: "Using Ephemeral Rollups for batch analysis gives me cleaner price data than any centralized API. Trustless and fast.",
    author: "David Kim",
    role: "Quant Trader",
    company: "Cipher Capital",
    metric: { value: "40x", label: "Faster than RPC" },
  },
  {
    quote: "Volume spike detection on QuickNode Streams alerts me to breakouts before they show up on TradingView.",
    author: "Sarah Williams",
    role: "Swing Trader",
    company: "Lunar Trades",
    metric: { value: "<600ms", label: "Alert latency" },
  },
];
...
export function TestimonialsSection() {
  ...
  // Generate ASCII pattern on client only to avoid hydration mismatch
  useEffect(() => {
