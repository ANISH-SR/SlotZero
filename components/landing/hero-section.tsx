...
const words = ["monitor", "detect", "alert", "track"];
    ...
    <section className="relative min-h-screen flex flex-col justify-center items-start overflow-hidden bg-black">
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 lg:px-12 py-32 lg:py-40">
        ...
        >
          <span className="inline-flex items-center gap-3 text-sm font-mono text-white/60">
            ...
            Real-time token monitoring with QuickNode + Ephemeral Rollups
          </span>
        </div>
        ...
        <div className="mb-12">
          ...
          >
            <span className="block whitespace-nowrap">Solana tokens,</span>
      ...
      >
        <div className="max-w-[1400px] mx-auto flex items-start gap-10 lg:gap-20">
          {[
            { value: "<600ms", label: "end-to-end latency" },
            { value: "1000+", label: "events per second" },
            { value: "40x", label: "faster than mainnet" },
          ].map((stat) => (
