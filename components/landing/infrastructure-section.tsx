          ...
          <div className="grid lg:grid-cols-[auto_1fr] gap-8 lg:gap-16 items-stretch">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className={`mt-8 text-xl text-muted-foreground leading-relaxed max-w-lg transition-all duration-1000 delay-100 ${
                ...
                Streams flow from QuickNode through MagicBlock ER to Solana L1. 
                Sub-600ms end-to-end latency with global node distribution.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className={`lg:col-span-2 relative p-8 lg:p-12 border border-foreground/10 bg-foreground/[0.02] overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              <div className="flex items-baseline gap-2 mb-4">
                <span className="text-8xl lg:text-[10rem] font-display leading-none">&lt;600</span>
                <span className="text-2xl text-muted-foreground">ms</span>
              </div>
              <p className="text-muted-foreground max-w-md">
                End-to-end latency from token event to dashboard alert. 100x faster than polling APIs.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6">
            <div className={`p-8 border border-foreground/10 bg-foreground/2 transition-all duration-700 delay-100 ${
              ...
              <span className="text-5xl lg:text-6xl font-display">1000+</span>
              <span className="block text-sm text-muted-foreground mt-2">Events per second</span>
            </div>
            
            <div className={`p-8 border border-foreground/10 bg-foreground/2 transition-all duration-700 delay-200 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}>
              <span className="text-5xl lg:text-6xl font-display">~100ms</span>
              <span className="block text-sm text-muted-foreground mt-2">Stream latency</span>
            </div>
          </div>
        </div>
